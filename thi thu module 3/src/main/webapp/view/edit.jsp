...
<div class="container-fluid">
    <form method="post" action="/product?action=edit">
        <div class="row">
            <div class="col-md-12">
                <p class="bg-success text-center">EDIT PRODUCT</p>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <input type="number" class="form-control" id="exampleInputEmail"
                           aria-describedby="emailHelp" name="id" value="${product.id}" required readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="exampleInputPassword3" name="price"
                           value="${product.price}">
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword2">Quantity</label>
                    <input type="number" class="form-control" id="exampleInputPassword2" name="quantity"

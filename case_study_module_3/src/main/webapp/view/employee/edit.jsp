                ...
                <div class="form-group">
                    ...
                    <select name="idPosition">
                        <c:forEach var="type" items="${positions}">
                            <option value="${type.id}" ${type.id==employee.idPosition?"selected":""}>${type.name}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="idEducation">
                        <c:forEach var="type" items="${educationDegrees}">
                            <option value="${type.id}" ${type.id==employee.idEducation?"selected":""}>${type.name}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="idDivision">
                        <c:forEach var="type" items="${divisions}">
                            <option value="${type.id}" ${type.id==employee.idDivision?"selected":""}>${type.name}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="form-group">

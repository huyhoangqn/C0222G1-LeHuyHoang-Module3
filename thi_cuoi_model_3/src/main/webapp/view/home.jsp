                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="/thuvien">Sách</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/benhan">Học Sinh</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/benhnhan">Thẻ Mượn Sách </a>
                        </li>
                    </ul>
                    <form class="form-inline my-2 my-lg-0">
                        <div>Lê Huy Hoàng </div>
                    </form>
                </div>
            </nav>
        </div>
